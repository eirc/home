...
plugins=(brew brew-cask bundler common-aliases git pass rails rvm tmux vi-mode
         zsh-syntax-highlighting)

# User configuration

export PATH="/usr/local/bin:/usr/local/sbin:$PATH:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/MacGPG2/bin"
